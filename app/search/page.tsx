  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pl-2 md:pl-6 pr-0 py-4">
        ...
        {/* Mobile categories horizontal scroller */}
        <div className="md:hidden -mx-2 px-2 pb-3">
          <div className="flex items-center gap-2 overflow-x-auto py-2">
            <button
              type="button"
              onClick={() => updateParam('category','')}
              className={`shrink-0 px-3 py-1.5 rounded-full border text-sm ${!category ? 'bg-primary text-primary-foreground border-primary' : 'bg-background'}`}
            >
              All categories
            </button>
            {categoriesList.map((c) => {
              ...
              return (
                <button
                  ...
                  className={`shrink-0 px-3 py-1.5 rounded-full border text-sm capitalize ${active ? 'bg-primary text-primary-foreground border-primary' : 'bg-background hover:bg-muted'}`}
                >
                  {c.name}
                </button>
              )
        ...
        {/* Mobile cities horizontal scroller */}
        <div className="md:hidden -mx-2 px-2 pb-4">
          <div className="flex items-center gap-2 overflow-x-auto py-2">
            <button
              type="button"
              onClick={() => updateParam('city','')}
              className={`shrink-0 px-3 py-1.5 rounded-full border text-sm ${!city ? 'bg-primary text-primary-foreground border-primary' : 'bg-background'}`}
            >
              All cities
            </button>
            {cities.map((ct) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-[15%_67%_14%] gap-6">
          ...
          <aside className="hidden md:block md:sticky md:top-24 self-start">
            <div className="bg-muted/50 border rounded-2xl shadow-sm md:max-h-[calc(100vh-12rem)] md:overflow-y-auto">
