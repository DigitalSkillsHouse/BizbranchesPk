...
export function ListingCard({ business, variant = "compact", className }: ListingCardProps) {
          ...
          <div className="p-3 sm:p-4">
            ...
            {business.city && (
              <div className="flex items-center gap-2 text-[10px] sm:text-xs text-gray-600 mt-1.5 pt-1.5 border-t border-gray-100">
                ...
                <span className="capitalize font-medium truncate">{business.city}</span>
              </div>
            )}
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              {business.city && (
                <div className="flex items-center text-muted-foreground text-xs sm:text-sm">
                  <MapPin className="h-3 w-3 mr-1 flex-shrink-0" aria-hidden />
